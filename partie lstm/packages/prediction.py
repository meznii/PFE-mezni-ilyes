...
class predector :
    def __init__(self):
        self.my_loaded_model = load_model('../models/prediction.h5')
        self.scaler_load = load(open('../models/scaler.pkl', 'rb'))
        self.scaler_load_output =  load(open('../models/scalerY.pkl', 'rb'))
